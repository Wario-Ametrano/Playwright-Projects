...
export default defineConfig({
  ...
  testIgnore: /.*\.setup\.ts/, // serve per ignorare i test di setup, in quanto non voglio che vengano eseguiti in parallelo con gli altri test 
  // lo stesso tempo, ma voglio che vengano eseguiti prima degli altri test
  ...
  projects: [
    {
      ...
      use: { user: "student", password: "Password123" },
    },
    {
      ...
      //questo progetto esegui tutti i test IN PARALLELO della directory testDir: './tests', dichiarata sopra in export default defineConfig
    },
        {
      name: "firefox",
